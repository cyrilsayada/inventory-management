...
export default {
  ...
  setup() {
    ...
    const items = ref([]);
    // Read from the shared composable so the top-bar search and the
    // in-page search box both filter through the same ref. Wiped in
    // App.vue's clear button OR by the in-page x button.
